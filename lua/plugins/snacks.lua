...
return {
  ...
  keys = {
    ...
    },
    {
      '<leader>gB',
      function()
        Snacks.picker.git_branches { layout = 'select', cwd = cwd() }
      end,
      desc = 'Git Branches',
    },
    {
      '<leader>gd',
      function()
        Snacks.picker.git_diff { cwd = cwd() }
      end,
      desc = 'Git Diff',
    },
    {
      '<leader>gF',
      function()
        Snacks.picker.git_log_file { cwd = cwd() }
      end,
      desc = 'Git Log File',
    },
    {
    ...
    },
    {
      '<leader>gS',
      function()
        Snacks.picker.git_stash { cwd = cwd() }
      end,
      desc = 'Git Stash',
    },
